...
<body>
    ...
    <div class="opcoes">
        ...
        <div class="motivacao">
            <div class="icone-botao">
                <img class="icones" src="img/icone_video.png">
                <a href="motivacao.php" class="button-grid">Acessar</a>
            </div>
            <div class="grid-areas">
                <h3>Conheça a Positive Mind</h3>
                <p>Transforme sua mentalidade! Assista ao vídeo e descubra como a Positive Mind pode impulsionar sua vida.</p>
            </div>
        </div>
        <div class="sobre">
            <div class="icone-botao">
